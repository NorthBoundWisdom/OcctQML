...
// 辅助方法：转换Qt事件到OCCT坐标
Graphic3d_Vec2i OcctGlTools::qtPointToOcct(const QPoint &qtPoint)
{
    return Graphic3d_Vec2i(qtPoint.x(), qtPoint.y());
}

//! Map Qt buttons bitmask to virtual keys.
Aspect_VKeyMouse OcctGlTools::qtMouseButtons2VKeys(Qt::MouseButtons theButtons)
{
...
Aspect_VKeyFlags OcctGlTools::qtMouseModifiers2VKeys(Qt::KeyboardModifiers theModifiers)
{
...
Aspect_VKey OcctGlTools::qtKey2VKey(int theKey)
{
    switch (theKey)
    {
    case 1060: // ru
